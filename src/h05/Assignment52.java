...
public class Assignment52 extends Applet{
        ...
        public void paint(Graphics g){
            ...
            g.setColor(Blue);
            g.fillRect(350, 85+(500-valerie), 75, valerie);

            // Jeroen 100kg
            int jeroen = 400;
            Color White = new Color(255, 255, 255);
            g.setColor(White);
            g.fillRect(650, 85+(500-jeroen), 75, jeroen);

            // Hans 80kg
            int hans = 320;
            Color Red = new Color(174, 28, 40);
            g.setColor(Red);
            g.fillRect(950, 85+(500-hans), 75, hans);
